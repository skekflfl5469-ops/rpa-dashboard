...
def load_rpa_complete_data(start_date, end_date, seed_val=42):
    ...
    raw_data = [
        {"업무명": "숙성부서 재고집품 지시서 메일링", "시간": "02:45:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-07-03"},
        {"업무명": "재고부서 재고집품 지시서 메일링", "시간": "03:00:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-05-14"},
        {"업무명": "조립부서 재고집품 지시서 메일링", "시간": "03:10:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-06-13"},
        ...
        {"업무명": "[유틸리티일상점검이탈 알림] 일상점검 이탈 사유 등록 요청 메일링", "시간": "09:40:00", "수행시간": "매일", "주기": "5회/주(월~금)", "부서": "DSF기획팀"},
        {"업무명": "[설비고장 사유등록 알림] MES 설비 고장 사유 등록 요청 메일링", "시간": "09:50:00", "수행시간": "매일", "주기": "5회/주(월~금)", "부서": "DSF기획팀"},
        ...
        {"업무명": "일단위 B2B 생산성 실적보고", "시간": "15:10:00", "수행시간": "매일", "주기": "5회/주(월~금)", "부서": "양지센터운영팀", "오픈일": "2026-06-25"},
            ...
            if is_run:
                ...
                if curr_date != curr_today and (curr_date, item['업무명']) in error_events:
                    generated_data.append({
                        ...
                        "날짜": curr_date, "상태": "오류", "구동시간": np.random.randint(10, 30),
                    ...
                    generated_data.append({
                        ...
                        "날짜": curr_date, "상태": "성공", "구동시간": np.random.randint(60, 120),
