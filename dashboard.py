...
def load_rpa_complete_data(start_date, end_date, seed_val=42):
    ...
    raw_data = [
        {"업무명": "숙성부서 재고집품 지시서 메일링", "시간": "02:45:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-07-03", "구동범위": (90, 120)},
        {"업무명": "재고부서 재고집품 지시서 메일링", "시간": "03:00:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-05-14", "구동범위": (10, 20)},
        {"업무명": "조립부서 재고집품 지시서 메일링", "시간": "03:10:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-06-13", "구동범위": (10, 20)},
        {"업무명": "선행생면(장,건면)_수기작업지시서 메일링", "시간": "04:00:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-07-14"},
        {"업무명": "선행생면(냉면,우동)_수기작업지시서 메일링", "시간": "06:00:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀", "오픈일": "2026-07-14"},
        ...
        {"업무명": "함안홈플러스 본품 ERP 주문내역 조회/수신", "시간": "09:10:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀"},
        {"업무명": "함안홈플러스 증정 ERP 주문내역 조회/수신", "시간": "09:15:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀"},
        {"업무명": "함안홈플러스 본품 발주서 주문내역 조회/수신", "시간": "09:20:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀"},
        {"업무명": "EAM 고장 접수 미 완료 및 비계획 고장 미 등록 관련", "시간": "09:30:00", "수행시간": "매일", "주기": "5회/주(월~금)", "부서": "DSF기획팀"},
        {"업무명": "SE시식/증정 ERP 주문내역", "시간": "09:30:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀"},
        {"업무명": "홈플러스 SE시식 주문 여부 조회 및 Share point 업로드", "시간": "09:30:00", "수행시간": "매일", "주기": "7회/주(월~일)", "부서": "음성센터운영팀"},
        ...
        {"업무명": "[설비정기점검 알림] [풀무원다논] 설비 정기점검 현황", "시간": "10:00:00", "수행시간": "매일", "주기": "2회/월(2,4주차 월요일)", "부서": "DSF기획팀"},
